const newsElements = {
	newsletterBody: document.getElementById('newsletterBody'),
	toastSection: document.getElementById('toastSection'),
	newsletterSidebar: document.getElementById('newsletterSidebar'),
	userImage: document.getElementById('userImage'),
	userName: document.getElementById('userName'),
	totalSubs: document.getElementById('totalSubs'),
	activeSubs: document.getElementById('activeSubs'),
	blockedSubs: document.getElementById('blockedSubs'),
	nonActive: document.getElementById('nonActive'),
	...
	modalSubscriptionStatus: document.getElementById('modalSubscriptionStatus'),
	...
	modalUpdatedTime: document.getElementById('modalUpdatedTime'),
};
